...
if __name__ == "__main__":
    ...
    LOGNAME = "navreptrainencodedenv_" + START_TIME + "_PPOLSTM" + ENCODER_ARCH
    LOGPATH = os.path.join(LOGDIR, LOGNAME + ".csv")
    MODELPATH = os.path.join(DIR, LOGNAME + "_ckpt")
    MODELPATH2 = os.path.join(DIR, "navreptrainencodedenv_latest_PPOLSTM_ckpt")
    ...
    cb = NavrepEvalCallback(eval_env, test_env_fn=test_env_fn, n_envs=N_ENVS,
