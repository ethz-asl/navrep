...
from navrep.models.vae1d import Conv1DVAE, reset_graph, MAX_LIDAR_DIST
...
if VARIANT == "ian":
    ...
    vae_path = os.path.expanduser("~/navrep/models/V/vae1d.json")
...
if VARIANT == "toy":
    ...
    vae_path = os.path.expanduser("~/navrep/models/V/toyvae1d.json")
    V_dataset_folder = os.path.expanduser("~/navrep/datasets/V/toy")
    M_dataset_folder = os.path.expanduser("~/navrep/datasets/M/toy")
if VARIANT == "markone":
    SS = None
    vae_path = os.path.expanduser("~/navrep/models/V/markonevae1d.json")
...
if VARIANT == "marktwo":
    SS = None
    vae_path = os.path.expanduser("~/navrep/models/V/marktwovae1d.json")
...
if VARIANT == "navreptrain":
    SS = None
    vae_path = os.path.expanduser("~/navrep/models/V/navreptrainvae1d.json")
...
for path in files:
    ...
    obs = np.clip(scans.astype(np.float) / MAX_LIDAR_DIST, 0.0, 1.)[:,:,None]
